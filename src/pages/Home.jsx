...
const TEAM = [
  {
    ...
    name: 'Имя Фамилия',
    role: 'CEO & Co-founder',
    bio: 'Отвечает за продукт и стратегию развития платформы.',
    about: 'Бывший преподаватель университета. Изучал образовательные системы в 5 странах. Основал Kurso чтобы решить проблему языкового барьера в образовании Кыргызстана.',
    email: 'ceo@kurso.kg',
    tg: '@ceo_kurso',
  },
  {
    ...
    about: 'Fullstack-разработчик с 8 годами опыта. Работал в стартапах Алматы и Бишкека. Строит масштабируемую платформу способную обслужить миллион пользователей.',
    email: 'cto@kurso.kg',
    tg: '@cto_kurso',
  },
  {
    ...
    about: 'Product designer с опытом в EdTech. Изучал пользовательское поведение местных студентов чтобы создать интерфейс адаптированный к нашей культуре.',
    email: 'design@kurso.kg',
    tg: '@design_kurso',
  },
]
